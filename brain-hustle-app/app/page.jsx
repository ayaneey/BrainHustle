	...
	return (
		<div className="mt-4 flex flex-col lg:flex-row xl:ml-8 ">
			<div className="lg:w-1/2">
				...
				<button className="custom-button mt-4 sm:mt-20 md:mt-28 lg:mt-6 xl:mt-12 xl:text-white xl:text-center xl:font-raleway xl:text-30 xl:font-normal xl:leading-120 xl:tracking-wide  sm-tablet:ml-96 ">
					Get In Touch
				</button>
			</div>
			<div className="lg:w-1/2 ">
